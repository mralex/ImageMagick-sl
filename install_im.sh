...
try_download http://"$SF_MIRROR".dl.sourceforge.net/project/ghostscript/GPL%20Ghostscript/9.00/ghostscript-9.00.tar.gz
try_download ftp://ftp.simplesystems.org/pub/libpng/png/src/libpng-1.4.5.tar.gz
try_download ftp://ftp.imagemagick.org/pub/ImageMagick/ImageMagick-6.6.7-2.tar.gz
